...
#ifndef _AMEBA_CRC_H_
#define _AMEBA_CRC_H_
...
_LONG_CALL_ int CRC_Calculate(CRC_InitTypeDef *CRC_InitStruct, const u8 *message, const u32 msglen, u32 *pCrc);
/**
  * @}
  */
...
#define CRC_LENGTH_MASK							((u32)0xFFFF0000)		/* Bit[31:16],  length			*/
/** @} */
