...
#define	APBPeriph_IRDA  APBPeriph_IRDA_REG

/* tx */
#define IR_BIT_TX_FIFO_LEVEL_INT_STATUS  	IR_TX_FIFO_LEVEL_INT_STATUS
#define IR_BIT_TX_FIFO_LEVEL_INT_CLR		IR_TX_FIFO_LEVEL_INT_CLR

#define IR_BIT_TX_FIFO_EMPTY				IR_TX_FIFO_EMPTY_STATUS
#define IR_BIT_TX_FIFO_EMPTY_INT_STATUS		IR_TX_FIFO_EMPTY_INT_STATUS
#define IR_BIT_TX_FIFO_EMPTY_INT_CLR		IR_TX_FIFO_EMPTY_INT_CLR

#define IR_BIT_TX_FIFO_OVER_INT_STATUS		IR_TX_FIFO_OVER_INT_STATUS
#define IR_BIT_TX_FIFO_OVER_INT_CLR			IR_TX_FIFO_OVER_INT_CLR

#define IR_BIT_TX_FIFO_LEVEL_INT_EN			IR_TX_FIFO_LEVEL_INT_EN
#define IR_BIT_TX_FIFO_LEVEL_INT_MASK		IR_TX_FIFO_LEVEL_INT_MASK
#define IR_BIT_TX_FIFO_LEVEL_INT_CLR		IR_TX_FIFO_LEVEL_INT_CLR



/* rx */
#define IR_BIT_RX_FIFO_FULL_INT_STATUS		IR_RX_FIFO_FULL_INT_STATUS
#define IR_BIT_RX_FIFO_FULL_INT_CLR			IR_RX_FIFO_FULL_INT_CLR

#define IR_BIT_RX_FIFO_LEVEL_INT_STATUS		IR_RX_FIFO_LEVEL_INT_STATUS
#define IR_BIT_RX_FIFO_LEVEL_INT_CLR		IR_RX_FIFO_LEVEL_INT_CLR

#define IR_BIT_RX_CNT_OF_INT_STATUS			IR_RX_CNT_OF_INT_STATUS
#define IR_BIT_RX_CNT_OF_INT_CLR			IR_RX_CNT_OF_INT_CLR

#define IR_BIT_RX_FIFO_OF_INT_STATUS		IR_RX_FIFO_OF_INT_STATUS
#define IR_BIT_RX_FIFO_OF_INT_CLR			IR_RX_FIFO_OF_INT_CLR

#define IR_BIT_RX_CNT_THR_INT_STATUS		IR_RX_CNT_THR_INT_STATUS
#define IR_BIT_RX_CNT_THR_INT_CLR			IR_RX_CNT_THR_INT_CLR

#define IR_BIT_RX_FIFO_ERROR_INT_STATUS		IR_RX_FIFO_ERROR_INT_STATUS
#define IR_BIT_RX_FIFO_ERROR_INT_CLR		IR_RX_FIFO_ERROR_INT_CLR

#define IR_BIT_RX_LEVEL 					IR_RX_LEVEL
