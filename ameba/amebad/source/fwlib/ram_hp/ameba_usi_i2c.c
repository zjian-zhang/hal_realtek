...
void USI_I2C_Init(USI_TypeDef *USIx, USI_I2C_InitTypeDef *USI_I2C_InitStruct)
{
	...
	if (USI_I2C_InitStruct->USI_I2CMaster) {
		...
		if ((USI_I2C_InitStruct->USI_I2CAddrMod == USI_I2C_ADDR_10BIT) || (USI_I2C_InitStruct->USI_I2CSpdMod == USI_I2C_HS_MODE) ||
			(USI_I2C_InitStruct->USI_I2CMstStartB != 0)) {
